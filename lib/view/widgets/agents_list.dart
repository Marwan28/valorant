...
class _AgentsListState extends State<AgentsList> {
            ...
            return GestureDetector(
              onTap: () {
                Navigator.of(context).push(MaterialPageRoute(
                    builder: (context) => dataAbilitiy(data, index)));
              },
              child: Container(
                decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                    image: NetworkImage(data[index].fullPortrait),
                    fit: BoxFit.cover,
                  ),
                ),
                child: Column(
  ...
  dataAbilitiy(data, index) {
    List<Ability> listAbilities = data[index].abilities;
            ...
            Column(
              children: [
                ...
                GridView.builder(
                  shrinkWrap: true,
                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: listAbilities.length == 4 ? 4 : 5,
                  ),
                  ...
                  itemBuilder: ((context, index) => ListTile(
                        title: GestureDetector(
                            ...
                            showDialog(
                                ...
                                builder: (context) {
                                  return AlertDialog(
                                    ...
                                    title: Text(
                                        listAbilities[index].displayName,
                                        style: const TextStyle(
                                            fontFamily: "Valorant",
                                    ...
                                    content:
                                        Text(listAbilities[index].description),
                                    backgroundColor: const Color(0xFF53212B),
                                    contentTextStyle:
                          ...
                          child: Container(
                              ...
                              child: Image.network(
                                  listAbilities[index].displayIcon)),
                        ),
                      )),
                ),
              ],
